...
function difficultyRule(fenn) {
  ...
  if (cat === "dil") {
    return `Bu, DİL (qrammatika) fənnidir (${fenn}) — bu, ƏDƏBİYYAT DEYİL, ƏSƏR/ŞAİR/YAZIÇI SUALI YAZMA. Yalnız dilin öz qaydaları üzərində sual qur: orfoqrafiya, sintaksis, morfologiya, punktuasiya, nitq hissələri, söz birləşmələri, cümlə üzvləri.
QƏTİ QADAĞAN NÜMUNƏLƏR: "X nədir?", "X neçə növə bölünür?" tipli sadə tərif sualı YAZMA.
ÇOX VACİB — BU KONKRET UYDURMA TERMİNLƏRDƏN HEÇ BİRİNİ İŞLƏTMƏ (bunlar Azərbaycan dilçiliyində MÖVCUD DEYİL, əvvəlki testlərdə səhvən yaranıb): "sintaktik çətir", "leksik çətir", "sait uydurma işarəsi", "saitlərin tərhəllüdü", "tərs cümlə", "cümlənin şərhən işlək üzvü", "assonans", "konsonans" (bu terminlər Azərbaycan dilçiliyinə aid deyil), "dilətrafı samit", "üstdamaq samiti" kimi qeyri-rəsmi fonetik təsnifat adları.
FONETİKA MÖVZUSUNDA XÜSUSİLƏ EHTİYATLI OL: fonetika Azərbaycan dilçiliyində ən çox səhvə yol verdiyin sahədir — YALNIZ tam əmin olduğun, real dərsliklərdə keçən terminlərdən istifadə et (məs. "sait ahəngi/əlaqəsi", "cingiltili/kar samitlər", "qapalı/açıq saitlər", "sait düşməsi", "samit düşməsi", "assimilyasiya"). Əgər hər hansı fonetik termindən tam əmin deyilsənsə, bu mövzudan sual YAZMA, əvəzinə morfologiya, sintaksis və ya punktuasiyadan sual qur — bunlar daha etibarlı sahələrdir.
Bunun əvəzinə hər sualda ƏN AZI biri olmalıdır: (a) verilmiş konkret cümlə üzərində qayda tətbiqi, (b) bir neçə qaydanın birləşdirilməsi, (c) səhv/düzgün variantlar arasında incə fərqin tapılması. Xarici dildirsə (İngilis/Rus/Alman/Fransız/Ərəb), o dilin qrammatikası və lüğəti üzərində eyni səviyyədə sual qur. Yalnız RƏSMİ, tanınmış qrammatik terminlərdən istifadə et.${precisionNote}`;
  }
  if (cat === "edebiyyat") {
